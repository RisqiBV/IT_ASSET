                                    ...
                                    <td>
                                      <a>
                                        <a href="dashboard.php">Edit  |  </a>
                                          ...
                                          <a href="delete.php?serial_number=<?=$data['serial_number'] ?>" onclick="return confirm('Hapus Inputan?')"/><button type="button" class="btn btn-danger btn-sm">Hapus</a></td></button>
