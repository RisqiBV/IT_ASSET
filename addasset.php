    ...
    <div class="row">
        ...
        <div class="card card-success">
            ...
            <form action="proses_addasset.php" method="POST">
                ...
                <br>
                <input class="form-control form-control-sm" type="text" name="system_type" placeholder="Type">
                <br>
                ...
                <br>
                <input class="form-control form-control-sm" type="text" name="type_account" placeholder="Type Account">
                <br>
